...
$(window).load(function() {
	...
	=================================================================================*/	
	$('.projectsList.grayscale .item img,.related-project img').hoverizr({effect:"grayscale",speedIn:"slow",speedOut: "slow"});
	$('.projectsList.grayscale .item canvas,.related-project canvas').css('opacity','0');
	$('#content .projectsList .project-item-preview img,.related-project img').css('opacity','0');
		$('#content .projectsList .project-item-preview').each(function(i){
